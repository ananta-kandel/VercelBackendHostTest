...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\User\\Documents\\VercelHostingTest\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\User\\Documents\\VercelHostingTest\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "postgres://default:oiHqd9saOUl6@ep-hidden-grass-a4uxgrht.us-east-1.aws.neon.tech:5432/verceldb?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n  author    User    @relation(fields: [authorId], references: [id])\n  authorId  Int\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = \"postgres://default:oiHqd9saOUl6@ep-hidden-grass-a4uxgrht.us-east-1.aws.neon.tech:5432/verceldb?sslmode=require\"\n}\n",
  "inlineSchemaHash": "1e6bde68825a8493f92e9f8a51f9de44d0bf52f9270abf83e9328368c859eddf",
  "copyEngine": true
}
config.dirname = '/'
